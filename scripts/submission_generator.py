...
Main entrypoint for submission pipeline. Limits how many evidence (grounding)
pages are included per answer; change the slice below to run grounding experiments.
"""
...
def main() -> int:
    ...
    ap.add_argument("--phase", type=str, default="", help="Phase dir (eval)")
